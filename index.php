...
class index {
	...
	public function lists() {
		...
		if($type==0) {
			...
			if (isset($_GET['nianji_fl'])) {
				$urlrules = $urlrules."&nianji_fl=" . $_GET['nianji_fl'];
			}
			if (isset($_GET['xueke_fl'])) {
				$urlrules = $urlrules."&xueke_fl=" . $_GET['xueke_fl'];
			}
			if (isset($_GET['leibie'])) {
				$urlrules = $urlrules."&leibie=" . $_GET['leibie'];
			}
			if (isset($_GET['zhuti2'])) {
				$urlrules = $urlrules."&zhuti2=" . $_GET['zhuti2'];
			}
			if (isset($_GET['banben2'])) {
				$urlrules = $urlrules."&banben2=" . $_GET['banben2'];
			}
			if (isset($_GET['banbie'])) {
				$urlrules = $urlrules."&banbie=" . $_GET['banbie'];
			}
			if (isset($_GET['area_fl'])) {
				$urlrules = $urlrules."&area_fl=" . $_GET['area_fl'];
			}
